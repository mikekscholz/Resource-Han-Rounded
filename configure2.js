...
const config = {
	...
	vendor: {
		id: 'MKS',
		name: 'Michael K Scholz',
		url: 'https://github.com/mikekscholz',
	},
	designer: 'Michael K Scholz & Cyano Hao (round all glyphs); Ryoko NISHIZUKA 西塚涼子 (kana, bopomofo & ideographs); Paul D. Hunt (Latin, Greek & Cyrillic); Sandoll Communications 산돌커뮤니케이션, Soo-young JANG 장수영 & Joo-yeon KANG 강주연 (hangul elements, letters & syllables)',
	copyright: "Copyright © 2024-2025 Michael K Scholz & © 2018—2022 Cyano Hao (https://github.com/CyanoHao). Portions © 2014-2021 Adobe (http://www.adobe.com/), with Reserved Font Name 'Source'.",
	license: {
	...
	orthography: {
		...
		shsMap: {
			'J':  'ResourceHanRoundedJ',
			'K':  'ResourceHanRoundedK',
			'SC': 'ResourceHanRoundedSC',
			'TC': 'ResourceHanRoundedTC',
			'HC': 'ResourceHanRoundedHC',
			'JP': 'ResourceHanRoundedJP',
			// 'KR': 'ResourceHanRoundedKR',
			'CN': 'ResourceHanRoundedCN',
			'TW': 'ResourceHanRoundedTW',
			'HK': 'ResourceHanRoundedHK',
			// 'NU': 'SourceHanSansNU'
		},
		ttc: ['J', 'K', 'SC', 'TC', 'HC'],
	},
...
const filename = {
	shs: subfamily => `src/rhr/${config.orthography.shsMap[subfamily]}-VF.otf`,
